...
export default async function HomeDesign1() {
            ...
            <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <div className="w-8 h-8 bg-blue-600 rounded flex items-center justify-center text-white font-bold">SR</div>
                        <span className="font-bold text-gray-900 tracking-tight">San Ramon Schools</span>
                    </div>
