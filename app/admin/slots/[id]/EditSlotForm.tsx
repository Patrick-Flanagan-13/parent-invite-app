    ...
    return (
        <form action={action} className="space-y-6">
            ...
            <div className="border-t border-gray-200 pt-6">
                <h3 className="text-lg font-bold text-gray-900 mb-4">Email Settings (Override)</h3>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    defaultValue={slot.confirmationEmailSubject || ''}
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={4}
                                    defaultValue={slot.confirmationEmailBody || ''}
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    defaultValue={slot.reminderEmailSubject || ''}
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={4}
                                    defaultValue={slot.reminderEmailBody || ''}
